...
// Query-Zeichenkette entschl�sseln
if (isset($_GET["get"])) {
...
// Query-Zeichenkette auf Vollst�ndigkeit �berpr�fen
if (!isset($QUERY["id"]) || !isset($QUERY["check_session_variable"])) {
	include("error.php");
	die;
}

// Verzeichnispfad �berpr�fen
...
// Eine Verzeichnisebene h�her anzeigen
